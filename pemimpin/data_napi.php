  ...
  ?>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                ...
                                <!-- <input style="margin-left: 85%; margin-top: px;" class="btn btn-success" type="submit" name="print" value="Cetak Data Narapidana" onclick="myFunction()" /> -->
                                <a id="key_print" href="data_napi_print.php">
                                    <button style="margin-left: 85%; margin-top: px;" class="btn btn-success">Cetak Data
                                        Narapidana</button>
                                </a>
                            </div>
                            <!-- /.box-header -->
    ...
    $(document).ready(function() {
        $('#example1').on('search.dt', function() {
            ...
            $("#key_print").attr("href", "data_napi_print.php?key=" + value);
