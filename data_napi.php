                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_napi.php?id=<?php echo $b['id']; ?>" type="button" class="btn btn-success fa fa-edit" style="width: 100px;">Edit</a>
                                                    <a href="delete_napi.php?id=<?php echo $b['id']; ?>" type="button" class="btn btn-danger fa fa-trash-o" style="width: 100px;">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
